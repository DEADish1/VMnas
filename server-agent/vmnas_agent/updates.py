...
STATE_PATH = Path("/var/lib/vmnas/update-status.json")
LOG_PATH = Path("/var/log/vmnas/update.log")
RUNNER = Path("/usr/local/sbin/vmnas-remote-update")
...
class ServerUpdater:
    ...
    def _is_running(self) -> bool:
        marker = Path("/run/vmnas-update.pid")
