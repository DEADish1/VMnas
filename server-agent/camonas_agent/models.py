...
class WindowsTuningConfig(BaseModel):
    enabled: bool = False
    local_account_name: str = Field(default="camonas", min_length=1, max_length=32, pattern=r"^[a-zA-Z0-9_.-]+$")
...
class DiscoveryInfo(BaseModel):
    ...
    pairing_url: str = ""
    web_url: str = ""
    mdns_name: str = "camonas.local"
    services: list[str] = ["_camonas._tcp", "_https._tcp"]
