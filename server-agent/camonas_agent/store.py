...
CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "details": "Stages VirtIO driver sources, Windows VM defaults, RDP shortcuts, and optional Camo NAS Windows setup tuning media.",
        "size_mb": 720,
    ...
    },
    {
        ...
        "name": "Docker Engine",
        "category": "Containers",
        "summary": "Run containers directly on Camo NAS.",
    ...
    },
    {
        ...
        "category": "Network",
        "summary": "Secure access to Camo NAS away from home.",
        "details": "Installs Tailscale on the server and exposes safe links for Proxmox, Camo NAS, SSH, and selected guest services.",
        "size_mb": 48,
        "tags": ["VPN", "Remote"],
        "dependencies": [],
    },
    {
        ...
        "category": "Network",
        "summary": "Host your own VPN on the Camo NAS server.",
    ...
    },
    {
        ...
        "details": "Deploys Transmission with persistent config, downloads, and watch folders under /srv/camonas. The web UI is intended for trusted LAN/VPN access and ships with change-me credentials.",
        "size_mb": 220,
    ...
    },
    {
        ...
        "details": "Deploys Jellyfin with movies, TV, music, and photo folders from the Camo NAS media library. Intended for easy LAN or VPN streaming without subscriptions.",
        "size_mb": 520,
    ...
    },
    {
        ...
        "details": "Deploys Navidrome for personal music streaming from /srv/camonas/media/music with persistent playlists, users, and scan data.",
        "size_mb": 120,
    ...
    },
    {
        ...
        "details": "Deploys Audiobookshelf with audiobook, podcast, and metadata folders under the Camo NAS media library.",
        "size_mb": 340,
    ...
    },
    {
        ...
        "details": "Deploys File Browser against the Camo NAS shares folder for browser-based upload, download, rename, and delete.",
        "size_mb": 95,
        "tags": ["NAS", "Files", "Web"],
        "dependencies": ["docker-engine"],
    },
    ...
    },
    {
        ...
        "details": "Deploys Duplicati with access to Camo NAS share folders and encrypted backup target configuration.",
        "size_mb": 260,
    ...
    },
    {
        ...
        "name": "Code Server",
        "category": "Developer",
        "summary": "Browser-based VS Code on Camo NAS.",
...
class ModuleStore:
    ...
    def default(cls) -> "ModuleStore":
        path = Path(os.environ.get("CAMONAS_MODULE_STORE", "/var/lib/camonas/modules.json"))
        if not os.access(path.parent, os.W_OK):
            path = Path.home() / ".camonas" / "modules.json"
